...
class OrderService {
  async createFarmerOrder(payload: OrderRequest): Promise<ApiResponse<FarmerOrder>> {
    return await apiClient.post<ApiResponse<FarmerOrder>>(API_ENDPOINTS.ORDER.CREATE_FARMER, payload);
  }
  ...
  async getFarmerOrderById(id: string): Promise<ApiResponse<FarmerOrder>> {
    return await apiClient.get<ApiResponse<FarmerOrder>>(API_ENDPOINTS.ORDER.BY_FARMER_ID(id));
  }
  ...
  async cancelFarmerOrder(id: string): Promise<ApiResponse<FarmerOrder>> {
    return await apiClient.put<ApiResponse<FarmerOrder>>(API_ENDPOINTS.ORDER.CANCEL_FARMER(id));
  }
  ...
  async acceptFarmerOrder(id: string): Promise<ApiResponse<FarmerOrder>> {
    return await apiClient.put<ApiResponse<FarmerOrder>>(API_ENDPOINTS.ORDER.ACCEPT_FARMER(id));
  }
  ...
  async updateFarmerOrderStatus(
    ...
    return await apiClient.put<ApiResponse<FarmerOrder>>(API_ENDPOINTS.ORDER.UPDATE_FARMER_STATUS(id), status);
  }
  ...
  async updateSupplierOrderStatus(
    ...
    return await apiClient.put<ApiResponse<SupplierOrder>>(
