...
export const API_ENDPOINTS = {
  ...
  GOVERNMENT: {
    ...
    USERS_BY_EMAIL: (email: string) => `/governments/users/${email}`,
    USERS_SUPPLIERS: '/governments/users/suppliers',
    USERS_FARMERS: '/governments/users/farmers',
    USERS_BUYERS: '/governments/users/buyers',
    PRODUCTS_SUPPLIERS: '/governments/products/suppliers',
    PRODUCTS_FARMERS: '/governments/products/farmers',
    ORDERS_SUPPLIERS: '/governments/orders/suppliers',
    ORDERS_FARMERS: '/governments/orders/farmers',
  },
  FILES: {
