...
function ProductManagement() {
  const { products, loading, deleteProduct, refreshProducts } = useAdmin();
              ...
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold text-gray-900">
                    {products?.filter(p => p.productStatus === 'IN_STOCK').length || 0}
                  </p>
                </div>
              </div>
            </div>
            <div className="bg-white rounded-lg shadow-sm border p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold text-gray-900">
                    {products?.filter(p => p.productStatus === 'LOW_STOCK').length || 0}
                  </p>
                </div>
              </div>
            </div>
            <div className="bg-white rounded-lg shadow-sm border p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold text-gray-900">
                    {products?.filter(p => p.productStatus === 'OUT_OF_STOCK').length || 0}
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-gray-900">
                      RWF {selectedProduct.unitPrice}/{selectedProduct.measurementUnit}
                    </p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-gray-900">{selectedProduct.productStatus?.replace('_', ' ')}</p>
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700">Certification</label>
                    <p className="mt-1 text-sm text-gray-900">{selectedProduct.certification}</p>
                  </div>
                </div>
