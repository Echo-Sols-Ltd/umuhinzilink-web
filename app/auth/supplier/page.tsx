...
import { Eye, EyeOff, User, MapPin, Briefcase, Upload, X, Loader2, UserCheck, Building } from 'lucide-react';
...
export default function SupplierSignUp() {
  ...
  const {
    ...
    errors,
    submissionState
  } = useEnhancedFormValidation(supplierFormFields, {
  ...
  return (
    <div className="w-full min-h-screen bg-gradient-to-br from-[var(--bg-secondary)] to-[var(--bg-tertiary)] flex flex-col items-center">
      ...
      <FormSuccessAnimation
        show={showSuccess}
        message="Welcome to UmuhinziLink! Your supplier account has been created successfully."
