...
export default function useUserAction() {
    ...
    const [uploadingFiles, setUploadingFiles] = useState<{ file: string; progress: number; cancel: () => void }[]>([]);
    ...
    const uploadFile = async (file: string) => {
        ...
        try {
            ...
            const response = await userService.uploadAvatar(file, (event: import('axios').AxiosProgressEvent) => {
